<div class="container">
	<div class="row">
		<div style="background-color:rgba(255,247,255,.8)" class="col-md-9 col-md-offset-2 panel panel-default">
			...
			<div class="myForm">
				<div class="dateRange">
					<label for="fundFromDate">From:&nbsp;</label><input
						id="fundFromDate" type="text" placeholder="01/01/2005"> <label
						for="fundToDate">To:&nbsp;</label><input id="fundToDate"
						type="text" placeholder="12/31/2013">
				</div>
				...
				<div style="margin-top: .5em">
					<label class="checkbox-inline"> <input type="checkbox"
						id="fundIndividualCheckbox" value="option1" checked> Individuals
					</label> <label class="checkbox-inline"> <input type="checkbox"
						id="fundPortfolioCheckbox" value="option2" checked> Portfolios
					</label>
				</div>
				<div class="radio">
				...
				<div class="submit">
					<button id="fundSubmitButton" type="button" class="btn btn-primary">
						Refresh Fund Info&nbsp;&nbsp;<i class="glyphicon glyphicon-refresh"></i>
					</button>
				</div>
			</div>
				...
				<table id="fund-table"
					...
					<thead id="fund-table-heading">
						<tr>
							...
							<th class="col2 column">Starting Worth ($)</th>
							<th class="col3 column">Ending Worth ($)</th>
							<th class="col4 column">Return/Yr (%)</th>
							<th class="col5 column">Cash ($)</th>
							<th class="col6 column">Investments ($)</th>
							<th class="col7 column">Type</th>
						</tr>
					</thead>
